!function(i) {
    ...
    e.prototype.getSlideCount = function() {
        var e, t, o, s = this;
        return o = !0 === s.options.centerMode ? Math.floor(s.$list.width() / 2) : 0,
        t = -1 * s.swipeLeft + o,
    ...
    ,
    e.prototype.setSlideClasses = function(i, e) {
        var t, o, s, n, r = this;
        if (o = r.$slider.find(".slick-slide").removeClass("slick-active slick-center slick-current").attr("aria-hidden", "true"),
        r.$slides.eq(i).addClass("slick-current"),
        null != e) {
            if (0 == i && 1 != e) {
                var l = this.$slides.eq(this.$slides.size() - 1)
                  , d = o.index(l);
                o.eq(d + 1).addClass("slick-current")
            }
            if (i == this.$slides.size() - 1 && e != this.$slides.size() - 2) {
                l = this.$slides.eq(0),
                d = o.index(l);
                o.eq(d - 1).addClass("slick-current")
            }
        }
        if (!0 === r.options.centerMode) {
            var a = r.options.slidesToShow % 2 == 0 ? 1 : 0;
            t = Math.floor(r.options.slidesToShow / 2),
            !0 === r.options.infinite && (i >= t && i <= r.slideCount - 1 - t ? r.$slides.slice(i - t + a, i + t + 1).addClass("slick-active").attr("aria-hidden", "false") : (s = r.options.slidesToShow + i,
            o.slice(s - t + 1 + a, s + t + 2).addClass("slick-active").attr("aria-hidden", "false")),
            0 === i ? o.eq(o.length - 1 - r.options.slidesToShow).addClass("slick-center") : i === r.slideCount - 1 && o.eq(r.options.slidesToShow).addClass("slick-center")),
            r.$slides.eq(i).addClass("slick-center")
        } else
            i >= 0 && i <= r.slideCount - r.options.slidesToShow ? r.$slides.slice(i, i + r.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false") : o.length <= r.options.slidesToShow ? o.addClass("slick-active").attr("aria-hidden", "false") : (n = r.slideCount % r.options.slidesToShow,
            s = !0 === r.options.infinite ? r.options.slidesToShow + i : i,
            r.options.slidesToShow == r.options.slidesToScroll && r.slideCount - i < r.options.slidesToShow ? o.slice(s - (r.options.slidesToShow - n), s + n).addClass("slick-active").attr("aria-hidden", "false") : o.slice(s, s + r.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false"));
    ...
    e.prototype.slideHandler = function(i, e, t) {
        ...
        !(!0 === a.animating && !0 === a.options.waitForAnimate || !0 === a.options.fade && a.currentSlide === i))
            ...
            !1 === a.options.infinite && !1 === a.options.centerMode && (i < 0 || i > a.getDotCount() * a.options.slidesToScroll))
                ...
                n = a.currentSlide,
                a.currentSlide = s,
                a.setSlideClasses(a.currentSlide, n),
